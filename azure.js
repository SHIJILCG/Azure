document.addEventListener('DOMContentLoaded', function () {
    ...
    function updateMenuBar2() {
        ...
        if (scrollPosition >= 0 && scrollPosition < 2900) {
            item1.style.opacity='1';
            item2.style.opacity='0';
            item3.style.opacity='0';
            item4.style.opacity='0';
            item5.style.opacity='0';
        } else if (scrollPosition >= 2900 && scrollPosition < 4200) {
            item1.style.opacity='0';
            item2.style.opacity='1';
            item3.style.opacity='0';
            item4.style.opacity='0';
            item5.style.opacity='0';
        } else if (scrollPosition >= 4200 && scrollPosition < 6800) {
            item1.style.opacity='0';
            item2.style.opacity='0';
            item3.style.opacity='1';
            item4.style.opacity='0';
            item5.style.opacity='0';
        } else if (scrollPosition >= 6800 && scrollPosition < 7900) {
            item1.style.opacity='0';
            item2.style.opacity='0';
            item3.style.opacity='0';
